"""Added Column to Investment Table

Revision ID: fd0358df5b5e
Revises: 1ccd6c93a247
Create Date: 2018-06-21 18:01:32.336000
...
revision = 'fd0358df5b5e'
down_revision = '1ccd6c93a247'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('Inv_ROI_PerYear', mysql.FLOAT(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['U_id'], [u'users.id'], name=u'investments_ibfk_1'),
    sa.ForeignKeyConstraint(['per_id'], [u'persons.id'], name=u'investments_ibfk_2'),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('Ear_img', mysql.LONGBLOB(), nullable=True),
    sa.Column('Ear_FileName', mysql.VARCHAR(length=300), nullable=True),
    ...
    sa.ForeignKeyConstraint(['U_id'], [u'users.id'], name=u'earnings_ibfk_2'),
    sa.PrimaryKeyConstraint('id'),
    mysql_default_charset=u'utf8',
    mysql_engine=u'InnoDB'
    )
    ...
    sa.Column('Share_FileName', mysql.VARCHAR(length=300), nullable=True),
    sa.Column('Share_comm', mysql.VARCHAR(length=200), nullable=True),
    sa.ForeignKeyConstraint(['U_id'], [u'users.id'], name=u'shares_ibfk_1'),
    sa.ForeignKeyConstraint(['per_id'], [u'persons.id'], name=u'shares_ibfk_2'),
    sa.PrimaryKeyConstraint('id'),
    mysql_default_charset=u'utf8',
    mysql_engine=u'InnoDB'
    )
    ...
    sa.Column('Exp_img', mysql.LONGBLOB(), nullable=True),
    sa.Column('Exp_FileName', mysql.VARCHAR(length=300), nullable=True),
    sa.Column('Exp_date', mysql.DATETIME(), nullable=True),
    sa.Column('Exp_comm', mysql.VARCHAR(length=200), nullable=True),
    sa.ForeignKeyConstraint(['U_id'], [u'users.id'], name=u'expesnes_ibfk_1'),
    sa.ForeignKeyConstraint(['per_id'], [u'persons.id'], name=u'expesnes_ibfk_2'),
    sa.PrimaryKeyConstraint('id'),
    mysql_default_charset=u'utf8',
    mysql_engine=u'InnoDB'
    )
